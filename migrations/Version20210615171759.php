 ...
 */
final class Version20210615171759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activity (id INT NOT NULL, city_id INT NOT NULL, company_id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, reservation_url TEXT DEFAULT NULL, address TEXT NOT NULL, phone VARCHAR(30) DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, menu TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE road_trip (id INT NOT NULL, author_id INT DEFAULT NULL, ulid UUID NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, departure VARCHAR(255) NOT NULL, arrival VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
